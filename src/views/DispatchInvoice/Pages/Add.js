...
export default function DispatchInvoiceAdd(props) {
    ...
    const [isManufactureAddButtonDisable, setIsManufactureAddButtonDisable] = useState(true);
    ...
    async function AddDispatchDetails() {
        let model = {
            ...
            packNetWeight: parseFloat(dipatchInv.packNetWeight),
            noOfPackages: parseInt(dipatchInv.noOfPackages),
            teaGradeID: parseInt(dipatchInv.teaGradeID),
            grossQuantity: (Number(dipatchInv.packNetWeight) * Number(dipatchInv.noOfPackages)),
            sampleQuantity: sampleQuantity,
            netQuantity: parseFloat(dipatchInv.netQuantity),
    ...
    async function saveDispatchInvoice() {
        let updateModel = {
            ...
            dateOfDispatched: dipatchInv.dateOfDispatched.toISOString().split('T')[0],
            sellingMarkID: parseInt(dipatchInv.sellingMarkID),
            brokerID: parseInt(dipatchInv.brokerID),
            natureOfDispatch: parseInt(dipatchInv.natureOfDispatch),
        ...
        if (isUpdate == true) {
            ...
            if (dispatchList.length == 0) {
                ...
                if (approveAndNewBtnEnable) {
                    let response = await services.saveDispatchInvoice(updateModel, dispatchList);
    ...
    async function calculate() {
        ...
        if (isUpdate == true) {
            const calValue = (Number(dipatchInv.packNetWeight) * Number(dipatchInv.noOfPackages)) - Number(sampleQuantity)
    ...
    function handleChange2(e) {
        setIsManufactureAddButtonDisable(false)
    ...
    function settingFullyUtiliesed(data) {
        return data;
    }
    ...
    function settingGrossQty(data) {
        return data;
    }
    function settingSample(data) {
        return data;
    }
    function settingNetQty(data) {
        return data;
    }
    return (
        <Fragment>
                    ...
                    <Formik
                        ...
                        validationSchema={
                            Yup.object().shape({
                                ...
                                packNetWeight: Yup.number().required('Pack Net Weight is required').min("1", 'Type of Pack is required'),
                                noOfPackages: Yup.number().required('Number Of Packages is required').min("1", 'Number Of Packages is required'),
                                netQuantity: Yup.number().required('Net Quantity is required').min("1", 'Net Quantity is required'),
                                                        ...
                                                        <Card style={{ padding: 20, marginTop: 20 }}>
                                                            ...
                                                            <Grid container spacing={4}>
                                                                ...
                                                                <Grid item md={3} xs={12}>
                                                                    ...
                                                                    <TextField
                                                                        fullWidth
                                                                        error={Boolean(touched.packNetWeight && errors.packNetWeight)}
                                                                        helperText={touched.packNetWeight && errors.packNetWeight}
                                                                        name="packNetWeight"
                                                                        type='number'
                                                                        onBlur={handleBlur}
                                                                        onChange={(e) => handleChange(e)}
                                                                        ...
                                                                        <Table className={classes.table} aria-label="caption table">
                                                                            <TableHead>
                                                                                <TableRow>
                                                                                    ...
                                                                                    <TableCell>PNW (KG)</TableCell>
                                                                                    <TableCell>NOP</TableCell>
                                                                                    <TableCell>Grade</TableCell>
                                                                                    <TableCell>Gross Qty (KG)</TableCell>
                                                                                    <TableCell>Sample Qty (KG)</TableCell>
                                                                            ...
                                                                            <TableBody>
                                                                                {dispatchList.map((rowData, index) => (
                                                                                    <TableRow key={index}>
                                                                                        ...
                                                                                        <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                                                            {settingPnw(rowData.packNetWeight)}
                                                                                        </TableCell>
                                                                                        <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                                                        ...
                                                                                        <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                                                            {settingGrossQty(rowData.grossQuantity)}
                                                                                        </TableCell>
                                                                                        <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                                                            {settingSample(rowData.sampleQuantity)}
                                                                                        </TableCell>
                                                                                        <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                                                            {settingNetQty(rowData.netQuantity)}
                                                                                        </TableCell>
                                                                                        <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                                                            <DeleteIcon
                                                                                                style={{
