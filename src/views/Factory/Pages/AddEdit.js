...
export default function FactoryAddEdit() {
  const classes = useStyles();
  const [title, setTitle] = useState("Operation Entity Registration")
  ...
  useEffect(() => {
    ...
    if (decryptedID != 0) {
      setIsUpdate(true);
      setTitle("Update Operation Entity Registration");
                  ...
                  <Card>
                    ...
                    <PerfectScrollbar>
                          ...
                          <Grid className={classes.root1} item xs={12}>
                            <AppBar position="static">
                              <Tabs value={value} onChange={handleTabChange} variant={'fullWidth'} classes={{ indicator: classes.indicator }}
                                ...
                                <Tab label="Operation Entity Accounts" {...a11yProps(2)} style={{ color: "black" }} />
                      ...
                      <Box display="flex" justifyContent="flex-end" p={2}>
                        <Button button 
                          color="primary"
                          setdisable={isSubmitting || (isUpdate ? false : !checker) || ChechBeforeSave() || (isUpdate ? false : !checker1)}
                          disabled={disable}
                          type="submit"
                          variant="contained"
