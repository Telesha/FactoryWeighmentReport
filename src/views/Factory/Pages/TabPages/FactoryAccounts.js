          ...
          <Formik
            ...
            validationSchema={
              Yup.object().shape({
                ...
                accountName: Yup.string().max(150, 'Max 150 digits').matches(/^[A-Za-z_._\s]+$/, 'Account name must contains only texts').matches(/^(?!\s)/, 'Only alphabets and special characters are allowed').required('Account Name is required'),
              })
            }
            onSubmit={saveUser}
            enableReinitialize
