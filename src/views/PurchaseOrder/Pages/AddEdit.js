...
export default function PurchaseOrderAddEdit(props) {
  ...
  async function getItemCategoryNames() {
    const category = await services.getAllActiveItemCategory();
  ...
  function addItemToTable() {
    ...
    if (orderList.factoryItemSupplierID > 0) {
      var newItem = {
        ...
        totalDiscount: parseFloat(orderList.totalDiscount),
