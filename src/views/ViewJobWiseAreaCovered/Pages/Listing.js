...
export default function JobWiseAreaCoveredView() {
  ...
  async function createDataForExcel(array) {
    ...
    if (array != null) {
      array.map(x => {
        var vr = {
          'Job Type': x.jobTypeID == agriGenERPEnum.JobTypeID.Sundry ? 'Sundry' : 'Plucking',
          ...
          'Leaf': x.leafTypeID == agriGenERPEnum.LeafTypeID.GreenLeaf ? 'Green Leaf' : '-----',
          'Qty(Kg)': x.quantity,
        }
        res.push(vr);
      });
                    ...
                    <PerfectScrollbar>
                      ...
                      <Box minWidth={1050} hidden={isTableHide}>
                        <MaterialTable
                          ...
                          columns={[
                            { title: 'Job Type', field: 'jobTypeID', render: rowData => rowData.jobTypeID == agriGenERPEnum.JobTypeID.Sundry ? 'Sundry' : 'Plucking' },
                            ...
                            { title: 'Section Name', field: 'fieldName', },
                            { title: 'Area Covered(Hectare)', field: 'areaCoverd' },
                            { title: 'Remaining Area(Hectare)', field: 'remainArea' },
                            { title: 'Leaf Type', field: 'leafTypeID', render: rowData => rowData.leafTypeID == agriGenERPEnum.LeafTypeID.GreenLeaf ? 'Green Leaf' : '---' },
