...
import {
  ...
  CardHeader, MenuItem, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Collapse, Fab
                                                ...
                                                {collectionTypeNameArray.map((data1, index1) => (
                                                  <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                                    ...
                                                    {data1 === "Super Leaf" ? (parseInt(isMinEror[index]) === parseInt(index)) || (isMinEror["collectionType"] === data1) ?
                                                      ...
                                                      : (parseInt(isMaxEror[index]) === parseInt(index)) || (isMaxEror["collectionType"] === data1) ?
                                      ...
                                      return (
                                        <div>
                                          ...
                                          <Box display="flex" justifyContent="flex-end" p={2}>
                                            ...
                                            <Grid container justify="center" item md={4} xs={12}>
                                              <Typography className={classes.bold}>
                                                {balancePaymentInfo.debitInfo.filter(x => x.entryType === "2")
                                                  .reduce((totalDebit, item) => totalDebit + item.total, 0).toFixed(2)}
                                              </Typography>
                                            </Grid>
                                            <Grid container justify="center" item md={4} xs={12}>
                                              <Typography className={classes.bold}>
                                                {balancePaymentInfo.debitInfo.filter(x => x.entryType === "1" && x.transactionTypeID !== 33)
