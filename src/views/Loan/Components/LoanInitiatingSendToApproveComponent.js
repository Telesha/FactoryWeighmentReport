...
export const LoanInitiating = ({
    ...
    async function SubmitLoanRequest() {
        ...
        let object = {
            customerLoanID: 0,
            registrationNumber: parseInt(SelectedCustomerRegNumber.toString()),
            groupID: parseInt(userBasicDetails.GroupID.toString()),
            factoryID: parseInt(userBasicDetails.FactoryID.toString()),
            customerNIC: PersonalDetails.customerNicNumber,
        ...
        const resposnse = await Services.SaveLoanRequest(object);
                        ...
                        <Grid item md={6} xs={12}>
                            <Card style={{ maxHeight: '33rem', minHeight: '33rem' }}>
                                ...
                                <CardContent>
                                    ...
                                    >
                                        <MenuItem value={0} disabled={true}> --Select Customer Reg. No-- </MenuItem>
                                        {generateDropDownMenuRegNumber(RelatedCustomerRegNumbers)}
                                    </TextField>
