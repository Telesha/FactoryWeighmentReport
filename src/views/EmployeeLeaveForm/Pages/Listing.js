...
export default function EmployeeLeaveFormListing(props) {
    ...
    useEffect(() => {
        trackPromise(getFactoriesForDropDown(), getLeaveTypeForDropdown());
                                            ...
                                            {leaveRequestData.length > 0 ?
                                                <Box minWidth={1000}>
                                                    <Chip style={{ marginLeft: '1rem', backgroundColor: "#44a6c6 ", fontWeight: "bold" }} alignContent="center"
                                                        label={"Total Count : " + leaveRequestData.length}
                                                        clickable
                                                        color="primary"
                                                    />
                                                    <MaterialTable
