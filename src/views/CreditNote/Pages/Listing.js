...
export default function CreditNoteListing() {
  ...
  const handleClick = () => {
    ...
    navigate('/app/creditNote/addedit/' + encryptedGroupID + '/' + encryptedFactoryID + '/' + encryptedVoucherNumber);
  }
  ...
  async function searchDetail() {
    ...
    let requestModel = {
      ...
      creditnoteref: CreditNoteDetails.creditnoteref.toString(),
      fromDate: CreditNoteDetails.fromDate == null ? '' : CreditNoteDetails.fromDate.toISOString().split('T')[0],
      toDate: CreditNoteDetails.toDate == null ? '' :   CreditNoteDetails.toDate.toISOString().split('T')[0]
    }
                          ...
                          <Box minWidth={1000}>
                            <MaterialTable
                              ...
                              columns={[
                                ...
                                // { title: 'Credit Note No', field: 'creditNoteID' },
                                { title: 'Voucher Code', field: 'originalVoucherNo' },
                                // { title: 'Credit Note Reference Number', field: 'creditNoteReferenceNumber' },
                                {
                              ...
                              // {...CreditNoteDetailsList.statusID == 2 ?():null}
                              actions={[
                                ...
                                //   icon: VisibilityIcon,
                                //   tooltip: 'View',
                                //   onClick: (event, rowData) => handleClickView(rowData.originalVoucherNo)
                                // }
                              ]}
                            />
                          </Box> : null
