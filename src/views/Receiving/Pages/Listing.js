...
export default function ReceivingListing() {
  ...
  const handleClick = () => {
    ...
    navigate('/app/Receiving/addedit/' + encrypted + "/" + encryptedgroupID + "/" + encryptedfactoryID);
  }
  ...
  const handleClickApprove = (referenceNumber) => {
    ...
    encryptedgroupID = btoa(generalJournalList.groupID.toString());
    encryptedfactoryID = btoa(generalJournalList.factoryID.toString());
    navigate('/app/Receiving/approve/' + encrypted + "/" + encryptedgroupID + "/" + encryptedfactoryID);
  }
  ...
  const handleClickView = (referenceNumber) => {
    ...
    encryptedgroupID = btoa(generalJournalList.groupID.toString());
    encryptedfactoryID = btoa(generalJournalList.factoryID.toString());
    navigate('/app/Receiving/view/' + encryptedgroupID + "/" + encryptedfactoryID + '/MA==/MA==/MA==/MA==/' + encrypted); //MA== 0 value
  }
  ...
  async function getPermissions() {
    ...
    var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWRECEIVING');
                  ...
                  <PerfectScrollbar>
                    ...
                    <CardContent style={{ marginBottom: "2rem" }}>
                      <Grid container spacing={3}>
                        ...
                        <Grid item md={3} xs={12}>
                          <InputLabel shrink id="factoryID">Factory *</InputLabel>
                          <TextField select
