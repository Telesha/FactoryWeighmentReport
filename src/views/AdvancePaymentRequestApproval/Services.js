...
export default {
  ...
  getAdvancePaymentRequestsBYCustomerIDAndRouteID,
...
async function getAdvancePaymentRequestsBYCustomerIDAndRouteID(routeID, customerID) {
  const response = await CommonGet('/api/AdvancePaymentApproval/GetAdvancePaymentRequestsBYCustomerIDAndRouteID', "routeID=" + parseInt(routeID) + "&customerID=" + parseInt(customerID));
  return response.data;
}
