          ...
          <Formik
            ...
            validationSchema={
              Yup.object().shape({
                ...
                quantity: Yup.string().required('Quantity required').matches(/^[1-9\b]/, 'Minimum value is 1 & Only allow numbers'),
                remark: Yup.string(),
                reason: Yup.number().required('Reason required').min("1", 'Reason required'),
