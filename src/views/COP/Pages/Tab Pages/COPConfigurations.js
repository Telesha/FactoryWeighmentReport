...
export default function COPConfigurations(data) {
    ...
    const [title, setTitle] = useState("COP Configuration Mapping");
    ...
    async function GetParentSectionDetails() {
        const respose = await services.GetParentSectionDetails(data.data.groupID, data.data.factoryID)
    ...
    async function GetAllChartOfAccountDetails() {
        let requestModel = {
            accountFilterText: COPConfigurationDetails.accountFilterText,
