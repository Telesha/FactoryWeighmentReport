...
export default function COPReport(props) {
  ...
  async function GetCOPReportDetails() {
    let resultModel = {
      ...
      startDate: moment(COPReportDetails.startDate.toString()).format('YYYY-MM-DD').split('T')[0],
      endDate: moment(COPReportDetails.endDate.toString()).format('YYYY-MM-DD').split('T')[0],
