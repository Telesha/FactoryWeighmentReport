...
const screenCode = 'SELLINGMARKWISESALESREPORT';

export default function SellingMarkWiseSalesReport(props) {
    const [title, setTitle] = useState('Selling Mark Wise Sales Report');
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(
            p => p.permissionCode == 'VIEWSELLINGMARKWISESALESREPORT'
        );
