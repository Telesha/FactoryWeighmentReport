...
const screenCode = 'GRADEWISEAVERAGEREPORT';

export default function GradeWiseAverageReport(props) {
    const [title, setTitle] = useState('Grade Wise Average Report');
    ...
    const [gradeWiseAverageReportDetail, setGradeWiseAverageReportDetail] = useState({
        groupID: 0,
        factoryID: 0
    });
    ...
    }, [gradeWiseAverageReportDetail.groupID]);

    async function getPermission() {
        var permissions = await authService.getPermissionsByScreen(screenCode);
        var isAuthorized = permissions.find(
            p => p.permissionCode == 'VIEWGRADEWISEAVERAGEREPORT'
        );
        ...
        setGradeWiseAverageReportDetail({
            ...gradeWiseAverageReportDetail,
    ...
    async function getBuyerWiseSalesReportData() {
        ...
        let model = {
            groupID: parseInt(gradeWiseAverageReportDetail.groupID),
            factoryID: parseInt(gradeWiseAverageReportDetail.factoryID),
        ...
        const buyerSalesData = await services.getGradeWiseAverageReport(model);
    ...
    async function createFile() {
        ...
        var settings = {
            sheetName: 'Grade Wise Average Report',
            fileName:
                'Grade Wise Average Report ' +
        ...
        let dataA = [
            {
                sheet: 'Grade Wise Average Report',
        ...
        <Fragment>
            <Page className={classes.root} title={title}>
                <Container maxWidth={false}>
                    <Formik
                        initialValues={{
                            groupID: gradeWiseAverageReportDetail.groupID,
                            factoryID: gradeWiseAverageReportDetail.factoryID
                        }}
                                                ...
                                                <Grid container spacing={3}>
                                                    <Grid item md={3} xs={12}>
                                                        ...
                                                        <TextField
                                                            ...
                                                            value={gradeWiseAverageReportDetail.groupID}
                                                            variant="outlined"
                                                            id="groupID"
                                                            size='small'
                                                    ...
                                                    <Grid item md={3} xs={12}>
                                                        ...
                                                        <TextField
                                                            ...
                                                            onBlur={handleBlur}
                                                            onChange={e => handleChange(e)}
                                                            value={gradeWiseAverageReportDetail.factoryID}
                                                            variant="outlined"
                                                            id="factoryID"
                                                            size='small'
