...
const screenCode = 'LEAVEBALANCEREPORT';

export default function LeaveBalanceReport(props) {
  const [title, setTitle] = useState('Leave Balance');
  ...
  }, [leaveBalanceList.groupID, initialState]);
  ...
  }, [leaveBalanceList.estateID, initialState]);

  useEffect(() => {
    trackPromise(getGroupsForDropdown(), getPermission(), GetAllEmployeeSubCategoryMapping(), getEmployeeTypesForDropdown());
  }, []);
  ...
  async function getPermission() {
    ...
    var isAuthorized = permissions.find(
      p => p.permissionCode == 'VIEWLEAVEBALANCEREPORT'
    );
  ...
  async function GetDetails() {
    let model = {
      ...
      year: moment(leaveBalanceList.year).format('YYYY'),
      employeeTypeID: parseInt(leaveBalanceList.employeeTypeID),
      statusID: parseInt(leaveBalanceList.statusID)
    };
                      ...
                      <Grid container spacing={3}>
                        ...
                        <Grid item md={3} xs={12}>
                          ...
                          <TextField select fullWidth
                            ...
                            id="employeeTypeID"
                            name="employeeTypeID"
                            value={leaveBalanceList.employeeTypeID}
                            type="text"
                            variant="outlined"
                            onChange={e => handleChange(e)}
                          >
                        ...
                        <Grid item md={3} xs={12}>
                          ...
                          <TextField select
                            ...
                            name="statusID"
                            onChange={(e) => handleChange(e)}
                            value={leaveBalanceList.statusID}
                            variant="outlined"
                            id="statusID"
                          >
