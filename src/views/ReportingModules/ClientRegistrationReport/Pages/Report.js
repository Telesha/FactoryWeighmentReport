...
export default function ClientRegistrationDetailsReport(props) {
  const [title, setTitle] = useState("Client Registration Details Report");
  ...
  async function GetClientDetails() {
    ...
    getSelectedDropdownValuesForReport(clientDetail.groupID, clientDetail.factoryID);
  ...
  async function createFile() {
    ...
    var settings = {
      sheetName: 'Client Registration Report',
      fileName: 'Client Registration Report - ' + selectedSearchValues.groupName + ' - ' + selectedSearchValues.factoryName,
      writeOptions: {}
    }
    ...
    let dataA = [
      {
        sheet: 'Client Registration Report',
                    ...
                    <PerfectScrollbar>
                      ...
                      {clientDetailList.length > 0 ?
                        <Box display="flex" justifyContent="flex-end" p={2}>
                          ...
                          <ReactToPrint
                            documentTitle={"Client Registration Details Report"}
                            trigger={() => <Button
                              color="primary"
                              id="btnRecord"
                              type="submit"
