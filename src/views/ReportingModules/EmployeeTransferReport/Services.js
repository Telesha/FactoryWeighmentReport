...
async function GetEmployeeTransferReportData(model) {
  let response = await CommonPost('/api/EmployeeTransfer/GetEmployeeTransferReportData', null, model);
  return response;
}
