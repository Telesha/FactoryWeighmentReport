        ...
        <div>
          ...
          <Grid container spacing={3} style={{ marginTop: "1.5rem" }}>
            ...
            <Grid container spacing={1} style={{ marginTop: "0.5rem" }}>
              ...
              <Grid item xs={5}  >
                <Typography variant='h5' style={{ marginRight: "20rem", borderTop: "3px black solid" }} align="right">
                  <CountUp 
          ...
          <Grid container spacing={3} style={{ marginTop: "1.5rem" }}>
            ...
            <Grid container spacing={1} style={{ marginTop: "1.5rem" }}>
              ...
              <Grid item xs={5}  >
                <Typography variant='h5' style={{ marginRight: "20rem", borderTop: "3px solid black", borderBottom: "5px black double" }} align="right">
                  <CountUp 
