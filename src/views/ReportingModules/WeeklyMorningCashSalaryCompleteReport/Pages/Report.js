...
const screenCode = 'WEEKLYMORNINGCASHSALARTCOMPLETEREPORT';

export default function WeeklyMorningCashSalaryCompleteReport(props) {
    ...
    const [title, setTitle] = useState("Weekly Morning Cash Salary History Report")
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWWEEKLYMORNINGCASHSALARYCOMPLETEREPORT');
    ...
    async function GetDetails() {
        ...
        const response = await services.GetWeeklyMorningCashSalaryCompleteReportData(model);
    ...
    async function createFile() {
        ...
        var settings = {
            sheetName: 'Weekly Morning Cash Salary History Report',
            fileName:
                'Weekly Morning Cash Salary History Report - ' +
        ...
        let dataA = [
            {
                sheet: 'Weekly Morning Cash Salary History Report',
                                    ...
                                    <PerfectScrollbar>
                                        ...
                                        {dailylabourData.length > 0 ?
                                            <Box display="flex" justifyContent="flex-end" p={2}>
                                                ...
                                                <div>&nbsp;</div>
                                                <ReactToPrint
                                                    documentTitle={"Weekly Morning Cash Salary History Report"}
                                                    trigger={() => <Button
                                                        color="primary"
                                                        id="btnCancel"
                                                        variant="contained"
