...
const screenCode = 'TASKSUMMARYREPORT';
...
export default function TaskSummaryReport(props) {
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWTASKSUMMARYREPORT');
                                            ...
                                            <Grid container spacing={3}>
                                                ...
                                                <Grid item md={3} xs={12}>
                                                    ...
                                                    <TextField select fullWidth
                                                        ...
                                                        id="payPointID"
                                                        name="payPointID"
                                                        value={taskSummaryReport.payPointID}
                                                        type="text"
                                                        variant="outlined"
                                                        onChange={(e) => {
                                                            handleChange(e)
                                                ...
                                                <Grid item md={3} xs={12}>
                                                    ...
                                                    <TextField select
                                                        ...
                                                        onChange={(e) => handleChange(e)}
                                                        size='small'
                                                        value={taskSummaryReport.estateTaskID}
                                                        variant="outlined"
                                                        id="estateTaskID"
                                                    >
                                                ...
                                                <Grid item md={3} xs={12}>
                                                    ...
                                                    <TextField select
                                                        ...
                                                        size='small'
                                                        onChange={(e) => handleChange(e)}
                                                        value={taskSummaryReport.taskTypeID}
                                                        variant="outlined"
                                                        id="taskTypeID"
                                                    >
                                                ...
                                                <Grid item md={3} xs={12}>
                                                    ...
                                                    <TextField select
                                                        ...
                                                        onChange={(e) => handleChange(e)}
                                                        size='small'
                                                        value={taskSummaryReport.productID}
                                                        variant="outlined"
                                                        id="productID"
                                                    >
                                                ...
                                                <Grid item md={3} xs={12}>
                                                    <InputLabel shrink id="pluckingTypeID">
                                                    ...
                                                    <TextField select
                                                        ...
                                                        onChange={(e) => handleChange(e)}
                                                        size='small'
                                                        value={taskSummaryReport.pluckingTypeID}
                                                        variant="outlined"
                                                        id="pluckingTypeID"
                                                    >
                                                        {/* <MenuItem value="0">--Plucking And Non-Plucking--</MenuItem> */}
                                                        <MenuItem value="1">With Plucking</MenuItem>
                                                        <MenuItem value="2">Without Plucking</MenuItem>
                                                    </TextField>
                                                </Grid>
                                                <Grid item md={3} xs={12}>
                                                    ...
                                                    <TextField select
                                                        ...
                                                        onChange={(e) => handleChange(e)}
                                                        value={taskSummaryReport.taskSickLeaveID}
                                                        variant="outlined"
                                                        id="taskSickLeaveID"
                                                    >
