...
async function GetCashCustomerDetails(cashCustomerRequestModel) {

  let response = await CommonPost('/api/CashCustomer/GetCashCustomerDetails', null, cashCustomerRequestModel);
  return response;
}
