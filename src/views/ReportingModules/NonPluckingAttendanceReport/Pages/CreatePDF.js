                        ...
                        <Table aria-label="simple table" size='small'>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="right" style={{ fontSize: "10px", fontWeight: "bold", border: "1px solid black", padding: "3px", width: "80px" }}>Target</TableCell>
                                    <TableCell align="right" style={{ fontSize: "10px", fontWeight: "bold", border: "1px solid black", padding: "3px", width: "80px" }}>Actual</TableCell>
                            ...
                            <TableBody>
                                {attendanceData.map((row, i) => (
                                    <TableRow key={i}>
                                        ...
                                        <TableCell component="th" scope="row" align="right" style={{ fontSize: "10px", border: "1px dashed black", padding: "3px" }}> {row.target}</TableCell>
                                        <TableCell component="th" scope="row" align="right" style={{ fontSize: "10px", border: "1px dashed black", padding: "3px" }}> {row.actual}</TableCell>
