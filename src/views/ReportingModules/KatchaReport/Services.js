...
async function GetKatchaReportDetails(model) {
  let response = await CommonPost('/api/KatchaReport/GetKatchaReportDetails', null, model);
  return response;
}
...
async function GetWeeklyPaymentMasterByEstateID(estateID) {
  let response = await CommonGet('/api/WeeklyPaymentReport/GetWeeklyPaymentMasterByEstateID', "estateID=" + parseInt(estateID));
  return response.data;
}
