...
export default {
  ...
  GetWeeklyOutsiderSalaryCompleteReportDate
};
...
async function GetWeeklyOutsiderSalaryCompleteReportDate(model) {
  let response = await CommonPost('/api/WeeklyOutsiderSalaryComplete/GetWeeklyOutsiderSalaryCompleteReportDate', null, model);
  return response;
}
