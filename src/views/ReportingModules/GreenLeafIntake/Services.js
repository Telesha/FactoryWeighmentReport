...
export default {
  ...
  GetGreenLeafIntakeReportDetails
};
...
async function GetGreenLeafIntakeReportDetails(model) {
  let response = await CommonPost('/api/GreenLeafIntakeReport/GetGreenLeafIntakeReportDetails', null, model);
