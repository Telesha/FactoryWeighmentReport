...
export default function DailyCheckRollReport(props) {
  ...
  async function GetDetail() {
    ...
    newRes.forEach(x => {
      ...
      if(x.sessionID === 1 ){
        sessionName = "morning";
      }else if(x.sessionID === 2){
        sessionName = "noon";
      }else if(x.sessionID === 3){
        sessionName = "evening";
      }
      ...
      if (duplicateDate) {
        ...
        result.push({
          ...
          netPay: x.amount*agriGenERPEnum.DailyCheckRollViewAmount.OneKiloAmount,
          overKiloPay: x.dayOT*agriGenERPEnum.DailyCheckRollViewAmount.OverKiloAmount,
          totalPay: x.amount*agriGenERPEnum.DailyCheckRollViewAmount.OneKiloAmount + x.dayOT*agriGenERPEnum.DailyCheckRollViewAmount.OverKiloAmount,
        });
      }
    }); 
    ...
    if (array != null) {
      array.map(x => {
        var vr = {
          'EmployeeID': x.employeeID,
          'FullName': x.fullName,
          'EmployeeType': x.employeeType == 1 ? "Register" : "Unregister",
          'JobType': getjobTypeusingjobID(x.jobType),
          'WorkType': x.workType == 1 ? "Division Labour": "Lent Labour",
          'FieldName': x.fieldName,
          'GangName': x.gangName,
          'Amount': x.total,
          'DayOT': x.dayOT,
                                          ...
                                          <TableBody>
                                            {routeSummaryData.map((rowData, index) => (
                                              <TableRow key={index}>
                                                ...
                                                <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                  {(rowData.employeeType == 1 ? "Register" : "Unregister")}
                                                </TableCell>
                                                <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                  {getjobTypeusingjobID(rowData.jobType)}
                                                </TableCell>
                                                <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                  {(rowData.workType == 1 ? "Division Labour": "Lent Labour")}
                                                </TableCell>
                                                <TableCell component="th" scope="row" style={{ borderBottom: "none" }}>
                                                  {(rowData.fieldName)}
                                                </TableCell>
