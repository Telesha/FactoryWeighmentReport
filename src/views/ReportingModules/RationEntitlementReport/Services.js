...
async function GetRationEntitlementReport(model) {
  const response = await CommonPost('/api/RationEntitlementReport/GetRationEntitlementReport', null, model)
  return response;
}
