    ...
    if (array != null) {
      array.map(x => {
        var vr = {
          ...
          Target: x.targetCrop,
          LastMonth: x.cropAmountForLastMonth,
          Last3MonthAvg: x.lastThreeMonthAvg.toFixed(2)
        }
        res.push(vr);
      });
      var vr = {
        ...
        Target: routeSummaryTotal.targetCrop,
        LastMonth: routeSummaryTotal.cropAmountForLastMonth,
        Last3MonthAvg: routeSummaryTotal.lastThreeMonthAvg.toFixed(2)
      }
      res.push(vr);
    }
                            ...
                            <TableContainer component={Paper} >
                              <Table aria-label="caption table">
                                ...
                                <TableRow>
                                  ...
                                  <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                    <b> {routeSummaryTotal.targetCrop} </b>
                                  </TableCell>
                                  <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                    <b> {routeSummaryTotal.cropAmountForLastMonth} </b>
                                  </TableCell>
                                  <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                    <b> {routeSummaryTotal.lastThreeMonthAvg.toFixed(2)} </b>
                                  </TableCell>
                                </TableRow>
                              </Table>
                              <TablePagination
