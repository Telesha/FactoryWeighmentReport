...
async function GetPluckingAttendanceDetails(model) {
  let response = await CommonPost('/api/PluckingAttendanceReport/GetPluckingAttendanceReport', null, model);
  return response;
}
