...
export default function BankSummaryReport(props) {
    ...
    async function GetDetails() {
        ...
        let model = {
            ...
            applicableMonth: bankSummaryList.month,
            applicableYear: bankSummaryList.year
        }
                                    ...
                                    <PerfectScrollbar>
                                                    ...
                                                    <Grid container md={12} spacing={2} style={{ marginTop: '1rem', marginBottom: '1rem' }}>
                                                        ...
                                                        <Grid item md={10} xs={12}>
                                                            <Grid container mt={2} spacing={2}>
                                                                ...
                                                                <Grid item md={11} xs={12}><InputLabel >{"Rs. " + totalAmount.toFixed(2)}</InputLabel>
                                                                </Grid>
                                                            </Grid>
                                                        </Grid>
                                                    </Grid>
                                        ...
                                        {bankSummaryData.length > 0 ?
                                            <Box display="flex" justifyContent="flex-end" p={2}>
                                                ...
                                                />
                                                <div hidden={true}>
                                                    <CreatePDF ref={componentRef} BankSummaryList={bankSummaryList} TotalAmount={totalAmount}
                                                        BankSummarySearchData={selectedSearchValues} BankSummaryData={bankSummaryData} />
                                                </div>
                                            </Box> : null}
                                    </PerfectScrollbar>
                                </Card>
