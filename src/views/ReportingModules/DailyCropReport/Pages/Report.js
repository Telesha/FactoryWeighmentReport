...
export default function DailyCropReport(props) {
  ...
  async function GetDetails() {
    ...
    getSelectedDropdownValuesForReport(dailyCropDetail.groupID, dailyCropDetail.factoryID);
    ...
    if (array != null) {
      array.map(x => {
        var vr = {
          ...
          'Net Amount (KG)': x.netWeight.toFixed(2),
        }
        res.push(vr);
      });
      var vr = {
        ...
        'Supplier Name': '',
        'Leaf Type': '',
        'Net Amount (KG)': totalAmount.toFixed(2),
      }
      res.push(vr);
    }
