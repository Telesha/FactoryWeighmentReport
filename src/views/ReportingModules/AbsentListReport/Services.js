...
async function GetAbsentListDetailsReport(model) {
  let response = await CommonPost('/api/AbsentList/GetAbsentListDetailsReport', null, model);
  return response;
}
