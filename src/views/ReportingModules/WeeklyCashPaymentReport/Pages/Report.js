...
const screenCode = 'WEEKLYCASHPAYMENTREPORT';

export default function WeeklyCashPaymentReport(props) {
    const [title, setTitle] = useState("Weekly Cash Payment Report")
    ...
    async function getPermission() {
        ...
        var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWWEEKLYCASHPAYMENTREPORT');
    ...
    async function createDataForExcel(array) {
        ...
        if (array != null) {
            ...
            var vr = {
                ...
                'C.FWRD': selectedSearchValues.gangName === undefined ? 'Duffa: All Duffas' : 'Duffa: ' + selectedSearchValues.gangName,
                'Sat': 'From: ' + selectedSearchValues.fromDate,
                'Sun': 'To: ' + selectedSearchValues.toDate,
                'Mon': selectedSearchValues.registrationNumber == "" ? 'Reg.No: -' : 'Reg.No: ' + selectedSearchValues.registrationNumber,
                'Tue': selectedSearchValues.bookNumber == "" ? 'Book Number: -' : 'Book Number: ' + selectedSearchValues.bookNumber,
            };
            res.push(vr);
        }
    ...
    async function createFile() {
        ...
        var settings = {
            sheetName: 'Weekly Cash Payment Report',
            fileName:
                'Weekly Cash Payment Report - ' +
        ...
        let dataA = [
            {
                sheet: 'Weekly Cash Payment Report',
