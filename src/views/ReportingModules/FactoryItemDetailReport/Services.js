...
export default {
  ...
  GetFactoryItemDetailsForReport,
...
async function GetFactoryItemDetailsForReport(factoryItemDetailRequestModel) {
  let response = await CommonPost('/api/FactoryItemDetails/GetFactoryItemDetailsForReport', null, factoryItemDetailRequestModel);
  return response;
}
