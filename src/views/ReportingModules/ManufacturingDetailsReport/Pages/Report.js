...
export default function ManufacturingDetailsReport(props) {
  ...
  async function createDataForExcel(array) {
    ...
    if (array != null) {
      array.map(x => {
        var vr = {
          'From Date': x.fromDateOfManufaturing.split('T')[0],
          'To Date': x.toDateOfManufaturing.split('T')[0],
          'Quantity': x.greenLeafAmount,
          'Boild Leaf': x.boiledLeaf,
          'water Leaf': x.rainfallIn,
          'Quantity': x.witheredLeafAmount,
          'First Dool Amount': x.firstDhoolAmount,
          'Secound Dool Amount': x.secondDhoolAmount,
          'Third Dool Amount': x.thirdDhoolAmount,
          'Fouth Dool Amount': x.fourthDhoolAmount,
          'Big Bulk Amount': x.bigBulkAmount,
         }
        res.push(vr);
      });
    }
                            ...
                            <Table  aria-label="caption table">
                              <TableHead>
                               ...
                               <TableRow>
                                  ...
                                  <TableCell align={'center'}>First Dool Amount</TableCell>
                                ...
                                {manufacturingDetails.map((data, index) => (
                                  <TableRow key={index}>
                                    <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none"}}>
                                      {data.fromDateOfManufaturing.split('T')[0]}
                                    </TableCell>
                                    <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                      {data.toDateOfManufaturing.split('T')[0]}
                                    </TableCell>
                                    <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                      {data.greenLeafAmount}
                                    </TableCell>
                                    <TableCell align={'center'} component="th" scope="row" style={{ borderBottom: "none" }}>
                                      {data.boiledLeaf}
                                    </TableCell>
