...
export default {
  ...
  GetWeeklySalaryCompleteReportDate
};
...
async function GetWeeklySalaryCompleteReportDate(model) {
  let response = await CommonPost('/api/WeeklySalaryComplete/GetWeeklySalaryCompleteReportDate', null, model);
  return response;
}