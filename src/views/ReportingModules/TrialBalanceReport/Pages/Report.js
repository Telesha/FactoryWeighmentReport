    ...
    if (dataArray != null) {
      dataArray.map(x => {
        var detailModel = {
          ...
          'Open Debit (LKR)': x.openDebit,
          'Open Credit (LKR)': x.openCredit,
          'Transaction Debit (LKR)': x.transDebit,
          'Transaction Credit (LKR)': x.transCredit,
          'Closing Debit (LKR)': x.closingDebit,
          'Closing Credit (LKR)': x.closingCredit
        };
