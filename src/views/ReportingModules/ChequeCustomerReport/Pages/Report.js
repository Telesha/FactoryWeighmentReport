...
export default function ChequeCustomerReport(props) {
  ...
  useEffect(() => {
    if (chequeCustomerDetail.groupID != 0 && chequeCustomerDetail.factoryID != 0 && chequeCustomerDetail.month != '' && chequeCustomerDetail.year != '') {
      trackPromise(
        GetDetails()
      )
    }
  }, [chequeCustomerDetail.groupID, chequeCustomerDetail.factoryID, chequeCustomerDetail.routeID, chequeCustomerDetail.month, chequeCustomerDetail.year]);
  ...
  async function GetDetails() {
    ...
    let model = {
      ...
      applicableMonth: chequeCustomerDetail.month,
      applicableYear: chequeCustomerDetail.year
    }
