...
export default {
  ...
  GetEmployeeBiometricSummaryDetails,
...
async function GetEmployeeBiometricSummaryDetails(model) {
  const response = await CommonPost('/api/EmployeeBiometricDetails/GetEmployeeBiometricSummaryDetails', null, model)
  return response;
}
