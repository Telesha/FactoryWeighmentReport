          ...
          <Formik
            ...
            validationSchema={
              Yup.object().shape({
                ...
                itemCode: Yup.string().max(4, "Item Code must be lower than 4 characters").required('Item Code required').matches(/^[0-9\b]+$/, 'Only allow numbers'),
                itemName: Yup.string().max(30).required('Item Name required'),
                description: Yup.string().max(100),
                measuringUnit: Yup.number().required('Measuring unit required').min("1", 'Measuring unit required'),
