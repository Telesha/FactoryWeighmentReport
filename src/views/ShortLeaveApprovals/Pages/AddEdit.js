...
export default function ShortLeaveApprovalAddEdit(props) {
  const agriGenERPEnum = new AgriGenERPEnum();
  const componentRef = useRef([]);
  const [title, setTitle] = useState("Short Leave Approval")
  ...
  const handleClick = () => {
    navigate('/app/shortLeaveApproval/listing');
  }
  ...
  async function getPermission() {
    ...
    var isAuthorized = permissions.find(p => p.permissionCode == 'ADDEDITSHORTLEAVEAPPROVALS');
