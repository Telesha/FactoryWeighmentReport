...
export default function GangRegistrationAddEdit(props) {
  const [title, setTitle] = useState("Add Duffa")
          ...
          <Formik
            ...
            validationSchema={
              Yup.object().shape({
                ...
                gangCode: Yup.string().max(30).required('Duffa Code is required'),
                gangName: Yup.string().max(30).required('Duffa Name is required'),
              })
            }
            onSubmit={saveGang}
            enableReinitialize
