...
export default function PaymentListing() {
  ...
  const handleClick = () => {
    ...
    navigate('/app/Payment/addedit/' + encrypted + "/" + encryptedgroupID + "/" + encryptedfactoryID);
  }
  ...
  const handleClickApprove = (referenceNumber) => {
    ...
    encryptedgroupID = btoa(generalJournalList.groupID.toString());
    encryptedfactoryID = btoa(generalJournalList.factoryID.toString());
    navigate('/app/Payment/approve/' + encrypted + "/" + encryptedgroupID + "/" + encryptedfactoryID);
  }
  ...
  const handleClickView = (referenceNumber) => {
    ...
    encryptedgroupID = btoa(generalJournalList.groupID.toString());
    encryptedfactoryID = btoa(generalJournalList.factoryID.toString());
    navigate('/app/Payment/view/' + encryptedgroupID + "/" + encryptedfactoryID + '/MA==/MA==/MA==/MA==/' + encrypted); //MA== 0 value
  }
  ...
  async function getPermissions() {
    ...
    var isAuthorized = permissions.find(p => p.permissionCode == 'VIEWPAYMENT');
