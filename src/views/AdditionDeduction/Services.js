...
export default {
  ...
  UpdateNonPluckingAdditionDeductionData,
  UpdatePluckingAdditionDeductionData,
...
async function GetAdditionDeductionDetails(model) {
  let response = await CommonPost('/api/AdditionDeduction/GetAdditionDeductionData', null, model);
  return response;
}

async function UpdateNonPluckingAdditionDeductionData(updateModel) {
  const response = await CommonPost('/api/AdditionDeduction/UpdateNonPluckingAdditionDeductionData', null, updateModel);
  return response;
}

async function UpdatePluckingAdditionDeductionData(updateModel) {
  const response = await CommonPost('/api/AdditionDeduction/UpdatePluckingAdditionDeductionData', null, updateModel);
  return response;
}
